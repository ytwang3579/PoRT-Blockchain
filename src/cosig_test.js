...
// 3) Commit: The leader computes a collective challenge c =
...
// 4) Reply: In a final bottom-up phase, each node i waits
...
timelag = (endTime - startTime)/1000;
console.log(endTime);
